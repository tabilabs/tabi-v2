...
func encodeTmHeader(
	...
	result := map[string]interface{}{
		...
		"logsBloom":             ethtypes.Bloom{}, // inapplicable to Tabi
		"miner":                 miner,
		"nonce":                 ethtypes.BlockNonce{}, // inapplicable to Tabi
		"number":                (*hexutil.Big)(number),
		"parentHash":            lastHash,
		"receiptsRoot":          resultHash,
		"sha3Uncles":            common.Hash{}, // inapplicable to Tabi
		"stateRoot":             appHash,
		"timestamp":             hexutil.Uint64(header.Header.Time.Unix()),
		"transactionsRoot":      txHash,
		"mixHash":               common.Hash{},     // inapplicable to Tabi
		"excessBlobGas":         hexutil.Uint64(0), // inapplicable to Tabi
		"parentBeaconBlockRoot": common.Hash{},     // inapplicable to Tabi
		"hash":                  blockHash,
		"withdrawlsRoot":        common.Hash{}, // inapplicable to Tabi
		"baseFeePerGas":         (*hexutil.Big)(baseFee),
		"withdrawalsRoot":       common.Hash{},     // inapplicable to Tabi
		"blobGasUsed":           hexutil.Uint64(0), // inapplicable to Tabi
	}
	return result, nil
}
