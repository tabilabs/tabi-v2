...
import (
	...
	"github.com/tabilabs/tabi-v2/precompiles/addr"
	addrv552 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v552"
	addrv555 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v555"
	addrv562 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v562"
	addrv575 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v575"
	addrv600 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v600"
	addrv601 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v601"
	addrv603 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v603"
	addrv605 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v605"
	addrv606 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v606"
	addrv610 "github.com/tabilabs/tabi-v2/precompiles/addr/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/bank"
	bankv552 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v552"
	bankv555 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v555"
	bankv562 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v562"
	bankv580 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v580"
	bankv600 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v600"
	bankv601 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v601"
	bankv603 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v603"
	bankv605 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v605"
	bankv606 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v606"
	bankv610 "github.com/tabilabs/tabi-v2/precompiles/bank/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/common"
	"github.com/tabilabs/tabi-v2/precompiles/distribution"
	distrv552 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v552"
	distrv555 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v555"
	distrv562 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v562"
	distrv580 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v580"
	distrv605 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v605"
	distrv606 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v606"
	distrv610 "github.com/tabilabs/tabi-v2/precompiles/distribution/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/gov"
	govv552 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v552"
	govv555 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v555"
	govv562 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v562"
	govv580 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v580"
	govv605 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v605"
	govv606 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v606"
	govv610 "github.com/tabilabs/tabi-v2/precompiles/gov/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/ibc"
	ibcv552 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v552"
	ibcv555 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v555"
	ibcv562 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v562"
	ibcv580 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v580"
	ibcv601 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v601"
	ibcv603 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v603"
	ibcv605 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v605"
	ibcv606 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v606"
	ibcv610 "github.com/tabilabs/tabi-v2/precompiles/ibc/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/json"
	jsonv552 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v552"
	jsonv555 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v555"
	jsonv562 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v562"
	jsonv603 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v603"
	jsonv605 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v605"
	jsonv606 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v606"
	jsonv610 "github.com/tabilabs/tabi-v2/precompiles/json/legacy/v610"

	"github.com/tabilabs/tabi-v2/precompiles/pointer"
	pointerv552 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v552"
	pointerv555 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v555"
	pointerv562 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v562"
	pointerv575 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v575"
	pointerv580 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v580"
	pointerv600 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v600"
	pointerv605 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v605"
	pointerv606 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v606"
	pointerv610 "github.com/tabilabs/tabi-v2/precompiles/pointer/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/pointerview"
	pointerviewv552 "github.com/tabilabs/tabi-v2/precompiles/pointerview/legacy/v552"
	pointerviewv555 "github.com/tabilabs/tabi-v2/precompiles/pointerview/legacy/v555"
	pointerviewv562 "github.com/tabilabs/tabi-v2/precompiles/pointerview/legacy/v562"
	pointerviewv605 "github.com/tabilabs/tabi-v2/precompiles/pointerview/legacy/v605"
	pointerviewv606 "github.com/tabilabs/tabi-v2/precompiles/pointerview/legacy/v606"
	pointerviewv610 "github.com/tabilabs/tabi-v2/precompiles/pointerview/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/staking"
	stakingv552 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v552"
	stakingv555 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v555"
	stakingv562 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v562"
	stakingv580 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v580"
	stakingv605 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v605"
	stakingv606 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v606"
	stakingv610 "github.com/tabilabs/tabi-v2/precompiles/staking/legacy/v610"
	"github.com/tabilabs/tabi-v2/precompiles/wasmd"
	wasmdv552 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v552"
	wasmdv555 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v555"
	wasmdv562 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v562"
	wasmdv575 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v575"
	wasmdv580 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v580"
	wasmdv600 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v600"
	wasmdv601 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v601"
	wasmdv603 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v603"
	wasmdv605 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v605"
	wasmdv606 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v606"
	wasmdv610 "github.com/tabilabs/tabi-v2/precompiles/wasmd/legacy/v610"
)
...
func GetCustomPrecompiles(
	...
	bankVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(bankv610.NewPrecompile(bankKeeper, bankSender, evmKeeper, accountKeeper)),
	}
	...
	wasmdVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(wasmdv610.NewPrecompile(evmKeeper, wasmdKeeper, wasmdViewKeeper, bankKeeper)),
	}
	...
	jsonVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(jsonv610.NewPrecompile()),
	}
	...
	addrVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(addrv610.NewPrecompile(evmKeeper, bankKeeper, accountKeeper)),
	}
	...
	stakingVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(stakingv610.NewPrecompile(stakingKeeper, stakingQuerier, evmKeeper, bankKeeper)),
	}
	...
	govVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(govv610.NewPrecompile(govKeeper, evmKeeper, bankKeeper)),
	}
	...
	distrVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(distrv610.NewPrecompile(distrKeeper, evmKeeper)),
	}
	...
	ibcVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(ibcv610.NewPrecompile(transferKeeper, evmKeeper, clientKeeper, connectionKeeper, channelKeeper)),
	}
	...
	pointerVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(pointerv610.NewPrecompile(evmKeeper, bankKeeper, wasmdViewKeeper)),
	}
	...
	pointerviewVersions := VersionedPrecompiles{
		...
		"v6.1.0":      check(pointerviewv610.NewPrecompile(evmKeeper)),
	}
