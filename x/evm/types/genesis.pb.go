...
type AddressAssociation struct {
	TabiAddress string `protobuf:"bytes,1,opt,name=tabi_address,json=tabiAddress,proto3" json:"tabi_address,omitempty"`
...
func (m *AddressAssociation) GetTabiAddress() string {
	if m != nil {
		return m.TabiAddress
	}
	return ""
}
...
func init() {
	proto.RegisterType((*AddressAssociation)(nil), "tabichain.tabi-v2.evm.AddressAssociation")
	proto.RegisterType((*Code)(nil), "tabichain.tabi-v2.evm.Code")
	proto.RegisterType((*ContractState)(nil), "tabichain.tabi-v2.evm.ContractState")
	proto.RegisterType((*Nonce)(nil), "tabichain.tabi-v2.evm.Nonce")
	proto.RegisterType((*Serialized)(nil), "tabichain.tabi-v2.evm.Serialized")
	proto.RegisterType((*GenesisState)(nil), "tabichain.tabi-v2.evm.GenesisState")
}
...
func (m *AddressAssociation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TabiAddress) > 0 {
		i -= len(m.TabiAddress)
		copy(dAtA[i:], m.TabiAddress)
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.TabiAddress)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *AddressAssociation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TabiAddress", wireType)
			}
			...
			m.TabiAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
