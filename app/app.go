...
import (
	...
	"github.com/facjas/tabi-db/ss"
	tabidb "github.com/facjas/tabi-db/ss/types"
	"github.com/gorilla/mux"
	"github.com/rakyll/statik/fs"
	"github.com/spf13/cast"
	"github.com/tabilabs/tabi-v2/aclmapping"
	aclutils "github.com/tabilabs/tabi-v2/aclmapping/utils"
	"github.com/tabilabs/tabi-v2/app/antedecorators"
	appparams "github.com/tabilabs/tabi-v2/app/params"
	"github.com/tabilabs/tabi-v2/app/upgrades"
	v0upgrade "github.com/tabilabs/tabi-v2/app/upgrades/v0"
	"github.com/tabilabs/tabi-v2/evmrpc"
	"github.com/tabilabs/tabi-v2/precompiles"
	"github.com/tabilabs/tabi-v2/utils"
	"github.com/tabilabs/tabi-v2/utils/metrics"
	"github.com/tabilabs/tabi-v2/wasmbinding"
	"github.com/tabilabs/tabi-v2/x/evm"
	evmante "github.com/tabilabs/tabi-v2/x/evm/ante"
	"github.com/tabilabs/tabi-v2/x/evm/blocktest"
	evmkeeper "github.com/tabilabs/tabi-v2/x/evm/keeper"
	"github.com/tabilabs/tabi-v2/x/evm/querier"
	"github.com/tabilabs/tabi-v2/x/evm/replay"
	...
	ssconfig "github.com/facjas/tabi-db/config"
	_ "github.com/tabilabs/tabi-v2/docs/swagger"
)
...
var (
	...
	// Boolean to only emit tabid version and git commit metric once per chain initialization
	EmittedAtabidVersionMetric = false
...
type App struct {
	*baseapp.BaseApp
	...
	stateStore   tabidb.StateStore
	receiptStore tabidb.StateStore
...
func New(
	...
	bAppOptions, stateStore := SetupTabiDB(logger, homePath, appOpts, baseAppOptions)
	...
	supportedFeatures := "iterator,staking,stargate,tabi"
	wasmOpts = append(
	...
	app.HardForkManager.RegisterHandler(v0upgrade.NewHardForkUpgradeHandler(100_000, upgrades.ChainIDTabiHardForkTest, app.WasmKeeper))
...
func (app App) GetStateStore() tabidb.StateStore { return app.stateStore }

// BeginBlocker application updates every begin block
func (app *App) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	metrics.GaugeTabidVersionAndCommit(app.versionInfo.Version, app.versionInfo.GitCommit)
...
// The validation happens immediately after execution all part of DeliverTx (which is a path that goes through tabi-cosmos to runTx eventually)
