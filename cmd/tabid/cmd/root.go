...
import (
	...
	"github.com/tabilabs/tabi-v2/tools"
...
func addModuleInitFlags(startCmd *cobra.Command) {
	...
	startCmd.Flags().Bool("migrate-iavl", false, "Run migration of IAVL data store to TabiDB State Store")
